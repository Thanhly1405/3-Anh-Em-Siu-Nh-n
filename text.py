...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[TIMERTXT] = Text(str(1).zfill(3), WHITE, 13*TILEWIDTH, TILEHEIGHT, size)
        self.addText("SCORE", WHITE, 0, 0, size)
        self.addText("TIMER", WHITE, 13*TILEWIDTH, 0, size)
    ...
    def updateTimer(self, counter):
        self.updateText(TIMERTXT, str(counter + 1).zfill(3))
